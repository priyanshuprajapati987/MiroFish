...
<div class="range-wrapper">
                  <input 
                    ...
                    :style="{ '--percent': ((customMaxRounds - 10) / (effectiveMax - 10)) * 100 + '%' }"
                  />
                  <div class="range-marks">
                    <span>10</span>
                    <span 
                      class="mark-recommend" 
                      :class="{ active: customMaxRounds === effectiveMax }"
                      @click="customMaxRounds = effectiveMax"
                      :style="{ position: 'absolute', left: `calc(${(effectiveMax - 10) / (effectiveMax - 10) * 100}% - 30px)` }"
                    >{{ $t('step2.recommendedRounds', { rounds: effectiveMax }) }}</span>
